...
export class App extends Component {
  ...
  clearMessages = () => { 
    ...
    this.props.removeMessage(this.state.messages);
  }
...
export const mapDispatchToProps = dispatch =>  bindActionCreators({ removeUser, hasErrored, addMessage, removeMessages }, dispatch);
